...
/**
  * Hashing based on Keccak200 permutation. Assumes that the data is padded
  * to a multiple of the rate size.
  *
  ...
  *
  * @return 0 if successful, 1 otherwise (includes wrong padding).
  */
int
hash(
